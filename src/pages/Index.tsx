  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container px-4 py-6 md:py-12 max-w-5xl mx-auto">
        <div className="max-w-3xl mx-auto mb-6 md:mb-12 text-center">
          ...
          <h1 className={cn("text-2xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-3 md:mb-4", animations.fadeIn({
          delay: 0.1
        }))}>
            The simplest way to share text and code
          </h1>
          
          <p className={cn("text-base md:text-xl text-muted-foreground mb-8", animations.fadeIn({
          delay: 0.2
        }))}>
          ...
          <form onSubmit={handleSubmit} className={cn("max-w-md mx-auto", animations.fadeIn({
          delay: 0.3
        }))}>
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <Input type="text" value={customUrl} onChange={e => setCustomUrl(e.target.value.replace(/\s+/g, "-").toLowerCase())} className="pl-[120px]" placeholder="your-note-name" disabled={isSubmitting} />
              </div>
